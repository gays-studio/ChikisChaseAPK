...
.field private mGlView:Lcom/unity3d/player/Q;
...
.field mSoftInput:Lcom/unity3d/player/z;

.field private mState:Lcom/unity3d/player/S;

.field private mVideoPlayerProxy:Lcom/unity3d/player/c0;
...
.field private m_SplashScreen:Lcom/unity3d/player/K;
...
.method static bridge synthetic -$$Nest$fgetmGlView(Lcom/unity3d/player/UnityPlayer;)Lcom/unity3d/player/Q;
    .locals 0

    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/Q;
...
.method static bridge synthetic -$$Nest$fgetm_SplashScreen(Lcom/unity3d/player/UnityPlayer;)Lcom/unity3d/player/K;
    .locals 0

    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/K;
...
.method static bridge synthetic -$$Nest$fputmVideoPlayerProxy(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/c0;)V
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;

    return-void
.end method

.method static bridge synthetic -$$Nest$fputm_SplashScreen(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/K;)V
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/K;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/unity3d/player/O;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Lcom/unity3d/player/IUnityPlayerLifecycleEvents;)V
    ...
    invoke-direct {v3}, Lcom/unity3d/player/S;-><init>()V

    iput-object v3, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/S;
    ...
    iput-object v3, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInput:Lcom/unity3d/player/z;
    ...
    invoke-static {p2}, Lcom/unity3d/player/O;->a(Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/unity3d/player/K$a;->a()[Lcom/unity3d/player/K$a;
    ...
    invoke-direct {p2, v0, v3}, Lcom/unity3d/player/K;-><init>(Landroid/content/Context;Lcom/unity3d/player/K$a;)V

    iput-object p2, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/K;
    ...
    invoke-static {}, Lcom/unity3d/player/S;->d()Z
    ...
    new-instance v0, Lcom/unity3d/player/UnityPlayer$k;

    invoke-direct {v0, p0}, Lcom/unity3d/player/UnityPlayer$k;-><init>(Lcom/unity3d/player/UnityPlayer;)V
    ...
    invoke-virtual {p2, v2}, Lcom/unity3d/player/S;->d(Z)V

    new-instance p2, Lcom/unity3d/player/Q;

    invoke-direct {p2, p1, p0}, Lcom/unity3d/player/Q;-><init>(Landroid/content/Context;Lcom/unity3d/player/UnityPlayer;)V

    iput-object p2, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/Q;

    invoke-virtual {p0, p2}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->m_SplashScreen:Lcom/unity3d/player/K;
...
.method private EarlyEnableFullScreenIfEnabled()V
    ...
    sget-object v2, Lcom/unity3d/services/store/gpbl/proxies/gC/sbvkfehhhl;->OUOBUGCAf:Ljava/lang/String;
...
.method private checkResumePlayer()V
    ...
    invoke-virtual {v1, v0}, Lcom/unity3d/player/S;->a(Z)Z
...
.method private static loadNative(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/unity3d/player/S;->e()V
...
.method private pauseUnity()V
    ...
    invoke-virtual {v1}, Lcom/unity3d/player/S;->c()Z
    ...
    invoke-virtual {v1}, Lcom/unity3d/player/S;->b()Z
    ...
    invoke-direct {v4, p0, v1}, Lcom/unity3d/player/UnityPlayer$y;-><init>(Lcom/unity3d/player/UnityPlayer;Ljava/util/concurrent/Semaphore;)V

    goto :goto_0

    :cond_1
    new-instance v4, Lcom/unity3d/player/UnityPlayer$z;

    invoke-direct {v4, p0, v1}, Lcom/unity3d/player/UnityPlayer$z;-><init>(Lcom/unity3d/player/UnityPlayer;Ljava/util/concurrent/Semaphore;)V

    :goto_0
    iget-object v5, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/UnityPlayer$F;

    .line 1
    iget-object v6, v5, Lcom/unity3d/player/UnityPlayer$F;->a:Landroid/os/Handler;
    ...
    :cond_2
    sget-object v7, Lcom/unity3d/player/UnityPlayer$E;->a:Lcom/unity3d/player/UnityPlayer$E;
    ...
    .line 3
    iget-object v5, v5, Lcom/unity3d/player/UnityPlayer$F;->a:Landroid/os/Handler;
    ...
    sget-object v0, Landroidx/core/internal/QwV/DXQoWcrhKhhLBl;->RhFJSVmoSNGykKj:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/unity3d/player/S;->c(Z)V

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/S;

    invoke-virtual {v0, v2}, Lcom/unity3d/player/S;->e(Z)V
...
.method private swapViews(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/S;->b()Z
...
.method private static unloadNative()V
    ...
    invoke-static {}, Lcom/unity3d/player/S;->f()V
...
.method private updateDisplayInternal(ILandroid/view/Surface;)Z
    ...
    new-instance v2, Lcom/unity3d/player/UnityPlayer$v;

    invoke-direct {v2, p0, p1, p2, v1}, Lcom/unity3d/player/UnityPlayer$v;-><init>(Lcom/unity3d/player/UnityPlayer;ILandroid/view/Surface;Ljava/util/concurrent/Semaphore;)V
    ...
    :cond_1
    sget-object v6, Lcom/unity3d/player/UnityPlayer$E;->d:Lcom/unity3d/player/UnityPlayer$E;

    .line 2
    invoke-static {v5, v3, v6}, Landroid/os/Message;->obtain(Landroid/os/Handler;ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 3
    iget-object v3, v4, Lcom/unity3d/player/UnityPlayer$F;->a:Landroid/os/Handler;
    ...
    sget-object v2, Lcom/unity3d/player/UnityPlayer$E;->e:Lcom/unity3d/player/UnityPlayer$E;
    ...
    .line 7
    :cond_4
    invoke-virtual {v2}, Lcom/unity3d/player/UnityPlayer$v;->run()V
...
.method public addViewToPlayer(Landroid/view/View;Z)Z
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/Q;
    ...
    iget-object p2, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/Q;
    ...
    :goto_2
    iget-object v2, p0, Lcom/unity3d/player/UnityPlayer;->mGlView:Lcom/unity3d/player/Q;
...
.method public configurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lcom/unity3d/player/c0;->b()V
...
.method protected getKeyboardLayout()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInput:Lcom/unity3d/player/z;
    ...
    .line 1
    :cond_0
    iget-object v0, v0, Lcom/unity3d/player/z;->a:Landroid/content/Context;
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lcom/unity3d/player/Q;->c()Z
...
.method protected setupUnityToBePaused()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/unity3d/player/c0;->c()V
...
.method protected setupUnityToBeResumed()V
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/player/S;->e(Z)V

    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/unity3d/player/c0;->d()V
...
.method protected showVideoPlayer(Ljava/lang/String;IIIZII)Z
    ...
    iget-object v1, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;

    if-nez v1, :cond_0

    new-instance v1, Lcom/unity3d/player/c0;

    invoke-direct {v1, p0}, Lcom/unity3d/player/c0;-><init>(Lcom/unity3d/player/UnityPlayer;)V

    iput-object v1, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;

    :cond_0
    iget-object v2, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/c0;
    ...
    invoke-virtual/range {v2 .. v13}, Lcom/unity3d/player/c0;->a(Landroid/content/Context;Ljava/lang/String;IIIZJJLcom/unity3d/player/c0$a;)Z
...
.method public windowFocusChanged(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/unity3d/player/S;->b(Z)V
